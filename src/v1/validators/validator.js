...
// const db = require("../../NOSQL/database/mysql");
...
// exports.ParamIsNumber = [
//   param("id").isNumeric().withMessage("params has to be numeric"),
// ];
...
//     .not()
//     .isEmpty()
//     .withMessage("sprint is required"),
// ];
...
// exports.ProjectMember = [
//   check("userId").isNumeric().not().isEmpty().withMessage("userId is required"),
//   check("projectId")
//     .isNumeric()
//     .not()
//     .isEmpty()
...
//     .isEmpty()
//     .withMessage("projectId is required"),
//   check("taskId").isNumeric().not().isEmpty().withMessage("taskId is required"),
//   check("comment")
//     .trim()
//     .escape()
//     .not()
